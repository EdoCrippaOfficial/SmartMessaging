...
@PrepareForTest({MymessagesPresenter.class, FirebaseAuthHelper.class})
public class MymessagesPresenterTest {
    ...
    private MymessagesPresenter presenter;

    @Before
    public void setUp() throws Exception {
        view = mock(MymessagesFragment.class);
        presenter = new MymessagesPresenter();
    ...
    public void loadmessagesTest() {
        ...
        verify(firestoreHelper).readMymessages(uid);
    }
