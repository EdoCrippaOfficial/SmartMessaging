...
@PrepareForTest({CompletedmessagesPresenter.class, FirebaseAuthHelper.class})
public class CompletedmessagesPresenterTest {
    ...
    private CompletedmessagesPresenter presenter;

    @Before
    public void setUp() throws Exception {
        view = mock(CompletedmessagesFragment.class);
        presenter = new CompletedmessagesPresenter();
    ...
    public void loadmessagesTest() {
        ...
        verify(firestoreHelper).readCompletedmessages();
    }
