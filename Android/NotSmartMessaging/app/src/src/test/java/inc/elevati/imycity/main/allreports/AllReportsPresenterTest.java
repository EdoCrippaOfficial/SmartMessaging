...
@PrepareForTest({AllmessagesPresenter.class, FirebaseAuthHelper.class})
public class AllmessagesPresenterTest {
    ...
    private AllmessagesPresenter presenter;

    @Before
    public void setUp() throws Exception {
        view = mock(AllmessagesFragment.class);
        presenter = new AllmessagesPresenter();
    ...
    public void loadmessagesTest() {
        ...
        verify(firestoreHelper).readAllmessages();
    }
