...
/** Presenter associated to {@link CompletedmessagesFragment} */
public class CompletedmessagesPresenter implements MainContracts.messageListPresenter{
     ...
     * {@link CompletedmessagesPresenter#onLoadMessagesTaskComplete(QuerySnapshot)} has to be executed */
    private QuerySnapshot results;

    /** This flag is set when {@link CompletedmessagesPresenter#onUpdateTaskComplete()}
