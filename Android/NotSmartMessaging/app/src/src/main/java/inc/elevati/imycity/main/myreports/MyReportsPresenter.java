package inc.elevati.smartmessaging.main.mymessages;
...
/** Presenter associated to {@link MymessagesFragment} */
public class MymessagesPresenter implements MainContracts.messageListPresenter {
     ...
     * {@link MymessagesPresenter#onLoadMessagesTaskComplete(QuerySnapshot)} has to be executed */
    private QuerySnapshot results;

    /** This flag is set when {@link MymessagesPresenter#onUpdateTaskComplete()}
    ...
    public void loadmessages() {
        ...
        reader.readMymessages(FirebaseAuthHelper.getUserId());
    }
