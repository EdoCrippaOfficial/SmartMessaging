...
/** This fragment shows all messages starred by current user retrieved from the database */
public class StarredmessagesFragment extends Fragment implements MainContracts.messageListView, SwipeRefreshLayout.OnRefreshListener {
     ...
     */
    public static StarredmessagesFragment newInstance() {
        return new StarredmessagesFragment();
    }
    ...
    public void showmessageDialog(message message) {
        messageDialog dialog = messageDialog.newInstance(message, PAGE_STARRED);
