...
/** This fragment shows all messages created by current user retrieved from the database */
public class MymessagesFragment extends Fragment implements MainContracts.messageListView, SwipeRefreshLayout.OnRefreshListener {
    ...
    public void showmessageDialog(message message) {
        messageDialog dialog = messageDialog.newInstance(message, PAGE_MY);
