...
/** This fragment shows all messages retrieved from the database */
public class AllmessagesFragment extends Fragment implements MainContracts.messageListView, SwipeRefreshLayout.OnRefreshListener {
    ...
    public void showmessageDialog(message message) {
        messageDialog dialog = messageDialog.newInstance(message, PAGE_ALL);
